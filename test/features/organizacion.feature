...
Scenario Outline: To probe route code response  /organizacion
  ...
  |GET   |/v1/organizacion|./files/req/Vacio.json|200 OK       |
...
Scenario Outline: To probe response route /organizacion       
  ...
  |GET   |/v1/organizacion|./files/req/Vacio.json|200 OK         |./files/res1/Vok1.json |
  |POST  |/v1/organizacion|./files/req/Vacio.json|400 Bad Request|./files/res1/Ierr1.json|

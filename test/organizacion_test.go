...
func run_bee() {
	parametros := "ORGANIZACION_CRUD__HTTP_PORT=" + beego.AppConfig.String("httpport") + "ORGANIZACION_CRUD__DB_USER=" + beego.AppConfig.String("PGuser") + " ORGANIZACION_CRUD__DB_PASS=" + beego.AppConfig.String("PGpass") + " ORGANIZACION_CRUD__DB_URL=" + beego.AppConfig.String("PGurls") + " ORGANIZACION_CRUD__DB_NAME=" + beego.AppConfig.String("PGdb") + " ORGANIZACION_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
...
func iSendRequestToWhereBodyIsJson(method, endpoint, bodyreq string) error {
	...
	if method == "DELETE" {
		...
		ioutil.WriteFile("./files/res4/Ino.json", []byte(resDelete), 0644)
	}
	...
	if method == "POST" && resStatus == "201 Created" {
		...
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_tipo_organizacion»\",\r\n"
		...
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_tipo_organizacion\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res3/Ierr8.json", []byte(resDuplex), 0644)

		resDuplex = "{\r\n\t\"Development\": null,\r\n\t\"Message\": \"The request contains incorrect syntax\",\r\n\t\"Status\": \"400\",\r\n\t\"System\": {\r\n"
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_tipo_relacion_organizaciones»\",\r\n"
		resDuplex = resDuplex + "\t\t\"Detail\": \"Ya existe la llave (id)=(" + strconv.Itoa(int(Id)) + ").\",\r\n\t\t\"Hint\": \"\",\r\n\t\t\"Position\": \"\",\r\n\t\t\"InternalPosition\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"InternalQuery\": \"\",\r\n\t\t\"Where\": \"\",\r\n\t\t\"Schema\": \"core_new\",\r\n\t\t\"Table\": \"tipo_relacion_organizaciones\",\r\n\t\t\"Column\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_tipo_relacion_organizaciones\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res4/Ierr8.json", []byte(resDuplex), 0644)
	}
	return nil
}

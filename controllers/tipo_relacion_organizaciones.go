...
type TipoRelacionOrganizacionesController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoRelacionOrganizacionesController) URLMapping() {
...
// @Param	body		body 	models.TipoRelacionOrganizaciones	true		"body for TipoRelacionOrganizaciones content"
// @Success 201 {int} models.TipoRelacionOrganizaciones
// @Failure 403 body is empty
// @router / [post]
func (c *TipoRelacionOrganizacionesController) Post() {
	var v models.TipoRelacionOrganizaciones
...
// @Success 200 {object} models.TipoRelacionOrganizaciones
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TipoRelacionOrganizacionesController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *TipoRelacionOrganizacionesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// @router /:id [put]
func (c *TipoRelacionOrganizacionesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *TipoRelacionOrganizacionesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
